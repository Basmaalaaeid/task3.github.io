...
because there's only one place where you can really put the const: at the end of the function:
...
For instance, we could iterator over a vector as follows:
##std::vector<int> vec;
vec.push_back( 3 );
vec.push_back( 4 );
vec.push_back( 8 );
...
_**Use & to get the address of a variable**_
...
So 1110 (14) will be zero filed from the left.
_**Use && in a logical expression**_
...
_**Use & or && for function overloading**_
